...
def main():
    ...
    conv = ConversationHandler(
        ...
        states={ROLE:[CallbackQueryHandler(role)],QAYERDAN:[MessageHandler(filters.TEXT&~filters.COMMAND,qayerdan)],QAYERGA:[MessageHandler(filters.TEXT&~filters.COMMAND,qayerga)],OGIRLIK:[MessageHandler(filters.TEXT&~filters.COMMAND,ogirlik)],NARX:[MessageHandler(filters.TEXT&~filters.COMMAND,narx)],TEL:[MessageHandler(filters.TEXT&~filters.COMMAND,tel)]},
